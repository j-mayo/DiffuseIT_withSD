...
class GaussianDiffusion:
    ...
    def p_mean_variance(self, model, x, t, clip_denoised=True, denoised_fn=None, model_kwargs=None, encoder_hidden_states=None, do_classifier_free_guidance=True):
        """
        ...
        if encoder_hidden_states is None:
            ...
            model_output = model(x_input, self._scale_timesteps(t)[0], encoder_hidden_states=encoder_hidden_states, cross_attention_kwargs=None,).sample

        if do_classifier_free_guidance:
                noise_pred_uncond, noise_pred_text = model_output.chunk(2)
                model_output = noise_pred_uncond + 7.5 * (noise_pred_text - noise_pred_uncond)
